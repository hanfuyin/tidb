...
require (
	...
	github.com/pingcap/gofail v0.0.0-20181121072748-c3f835e5a7d8 // indirect
	...
	github.com/pingcap/pd v2.1.1+incompatible
	github.com/pingcap/tidb-tools v2.1.1+incompatible
